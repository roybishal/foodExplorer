...
<h2 className='font-bold text-green-600 text-2xl
 mt-10 mb-10 text-center '>About <span className='text-red-500'>Us</span></h2>
    ...
    <h3 className='text-6xl  lg:text-5xl sm:text-3xl min-[320px]:text-2xl mb-5 font-bold font'> Welcome to <span className='text-red-400'>Food Explorer </span> </h3> 
    <p className='text-base lg:text-base sm:text-sm  min-[320px]:text-sm  text-black font-medium'>At Food Explorer, we believe that great food and exceptional service go hand in hand. Our restaurant is a cozy and inviting 
