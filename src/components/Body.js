...
const Body = () => {
    ...
    async function getRestaurants(){
        const data= await fetch("https://corsproxy.io/?https://www.swiggy.com/dapi/restaurants/list/v5?lat=22.488300272096538&lng=88.32804770688476&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING");
